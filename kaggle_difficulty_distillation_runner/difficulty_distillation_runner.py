"""Pinned Kaggle GPU entrypoint for G6Q-KD4 difficulty-aware KD."""
...
def main():
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("G6Q-KD4 requires a Kaggle GPU")
    ...
    run(
        [
            ...
            "pytest",
            "-q",
            "tests/test_difficulty_distillation.py",
    ...
    output = Path("/kaggle/working/difficulty-distillation-q4-v1")
    command = [
        sys.executable,
        "run_difficulty_aware_distillation_screen.py",
        "--representations",
        representations,
        "--metadata",
        metadata,
    ...
    print("G6Q-KD4 difficulty-aware KD screen complete", flush=True)
