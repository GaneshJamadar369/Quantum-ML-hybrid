"""Kaggle runner for Phase 6Q-C1 projected IQP kernel search."""
...
def main() -> None:
    ...
    output = Path("/kaggle/working/g6c1-projected-quantum")
    ...
    run([
        sys.executable,
        "run_projected_quantum_search.py",
        "--metadata",
        str(metadata),
        "--features",
        str(features),
    ...
    print("=== Phase 6Q-C1 complete; folds 9 and 10 remain sealed ===", flush=True)
