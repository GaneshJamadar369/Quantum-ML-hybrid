"""Kaggle CPU runner for the direct-input four-qubit VQC screen."""
...
def main() -> None:
    ...
    output = Path("/kaggle/working/quantum-core-q4-screen")
    ...
    print("=== Direct quantum-core q4 screen complete; folds 9 and 10 sealed ===")
