"""Private Kaggle GPU runner for Reuploading Knowledge Distillation VQC fusion research."""
...
def main():
    ...
    command = [
        sys.executable, "run_reuploading_kd_vqc_screen.py",
        ...
        "--output", "/kaggle/working/reuploading-kd-vqc-fusion-v1",
        "--per-class", "500",
        "--epochs", "20",
        "--batch-size", "128",
        "--seed", "42",
    ...
    print("Reuploading Knowledge Distillation VQC screen complete", flush=True)
