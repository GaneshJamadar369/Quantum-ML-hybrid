"""Private Kaggle GPU runner for the supervised Transformer q12/12-qubit screen."""
...
def main():
    ...
    run([
        ...
        "--output", "/kaggle/working/supervised-q12-direct-screen",
        "--qubits", "12", "--per-class", "500", "--epochs", "20",
        "--batch-size", "64", "--seed", "20260922", "--device", "cuda",
    ], cwd=repo)
    print("q12/12-qubit OOF screen complete; folds 9 and 10 sealed", flush=True)
