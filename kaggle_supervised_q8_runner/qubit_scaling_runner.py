"""Private Kaggle GPU runner for the supervised Transformer q8/8-qubit screen."""
...
def main():
    ...
    run([
        ...
        "--output", "/kaggle/working/supervised-q8-direct-screen",
        "--qubits", "8", "--per-class", "500", "--epochs", "20",
        "--batch-size", "128", "--seed", "20260922", "--device", "cuda",
    ], cwd=repo)
    print("q8/8-qubit OOF screen complete; folds 9 and 10 sealed", flush=True)
