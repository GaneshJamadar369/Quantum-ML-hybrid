"""Private Kaggle fusion HQNN screen with Transformer waveform coordinates."""
...
def main():
    ...
    run([sys.executable, "run_qsvc_hqnn_screen.py", "--task", "hqnn", "--representations", str(representations),
         ...
         "--output", "/kaggle/working/transformer-hqnn-screen",
         "--per-class", "500", "--epochs", "20", "--seed", "20260922"], cwd=repo)
    print("Transformer HQNN screen complete; folds 9 and 10 sealed", flush=True)
